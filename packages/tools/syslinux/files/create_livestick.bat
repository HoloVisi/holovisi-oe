@ECHO OFF
TITLE HoloVisi LIVE USB Installer
...
ECHO.
ECHO.
ECHO                     HoloVisi LIVE USB Installer
ECHO.
ECHO.
ECHO  *****************************************************************
ECHO.
...
ECHO  *****************************************************************
ECHO.
ECHO                     Installing HoloVisi to %DRIVE%
...
ECHO  *****************************************************************
ECHO.
ECHO       HoloVisi failed md5 check - Installation will now quit
ECHO.
ECHO             Your original download is probably corrupt
ECHO       Please visit www.holovisi.com and download another copy
ECHO.
ECHO  *****************************************************************
ECHO.
ECHO.
...
ECHO  *****************************************************************
ECHO.
ECHO  The HoloVisi LIVE USB Installer has been successfully copied to %DRIVE%
