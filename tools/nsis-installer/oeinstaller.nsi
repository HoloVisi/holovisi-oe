...
VIAddVersionKey ProductName "HoloVisi USB Stick Creator"
VIAddVersionKey Comments "A bootable OpenElec Installer Stick creation tool."
VIAddVersionKey CompanyName "HoloVisi"
VIAddVersionKey LegalCopyright "HoloVisi"
VIAddVersionKey FileDescription "HoloVisi USB Stick Creator"
VIAddVersionKey FileVersion "1.0"
VIAddVersionKey ProductVersion "1.0"
VIAddVersionKey InternalName "HoloVisi USB Stick Creator"

!define PRODUCT_NAME "HoloVisi USB Stick Creator"
!define PRODUCT_VERSION "1.0"
!define PRODUCT_PUBLISHER "HoloVisi"
!define PRODUCT_WEB_SITE "http://holovisi.com"
BrandingText " "
...
!define MUI_ICON "holovisi.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "welcome.bmp"
!define MUI_ABORTWARNING

!define MUI_WELCOMEPAGE_TITLE "Welcome to the HoloVisi USB Stick Creator"
!define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the creation of an HoloVisi USB Installer Stick.\n\nPlease read the following pages carefully."
!insertmacro MUI_PAGE_WELCOME

!define MUI_PAGE_HEADER_TEXT "License Agreement"
!define MUI_PAGE_HEADER_SUBTEXT "Please review the GPLv2 license below before using the HoloVisi USB Stick Creator"
...
Section "oeusbstart"
  ...
  nsExec::Exec `"$0" /c copy holovisi.ico $DRIVE_LETTER`
  ...
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' '  MENU LABEL Run HoloVisi Installer'
  ...
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' '  MENU LABEL Run HoloVisi Live'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' '  KERNEL /KERNEL'
  ${If} $STORAGE_SIZE == "0"
...
!define MUI_FINISHPAGE_TITLE "HoloVisi USB Stick Successfully Created"
!define MUI_FINISHPAGE_TEXT "An HoloVisi USB Installer Stick has been created on the device $DRIVE_LETTER.\n\nPlease boot your HTPC off this USB stick and follow the on-screen instructions."
